...
import { Order, TailwindVariant } from '@/types';
...
import { Search, Filter, ShoppingCart, Eye, Package, Truck, CheckCircle } from 'lucide-react';
                              ...
                              <div className="space-y-6">
                                ...
                                <div>
                                  ...
                                  <div className="p-4 bg-gray-50 rounded-lg">
                                    ...
                                    <p className="text-sm text-gray-600 mt-1">{selectedOrder.customer.address}</p>
                                  </div>
                                </div>
